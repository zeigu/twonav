...
<div class="layui-fluid">
    <div class="layui-card">
        <div class="layui-card-header">易支付接口配置</div>
        ...
        <div class="layui-field-box">
         ...
         <div class="layui-input-block">
                 <input type="text" placeholder="请输入易支付接口地址" value="<?php echo $CONFIG['epay_url']; ?>" name="epay_url" class="layui-input"/>
         </div>
           </div>


          <div class="layui-form-item">
          <label class="layui-form-label">接口 ID</label>
          <div class="layui-input-block">
          <input type="text" placeholder="请输入易支付接口ID" value="<?php echo $CONFIG['epay_id']; ?>" name="epay_id" class="layui-input"/>
          </div>
            </div>
          ...
          <label class="layui-form-label">接口密钥</label>
           <div class="layui-input-block">
            <input type="text" placeholder="请输入易支付接口密钥" value="<?php echo $CONFIG['epay_key']; ?>" name="epay_key" class="layui-input"/>
           </div>
          </div>
