  ...
  <div class="lyear-login">
    <div class="login-center">
      <div class="login-header text-center">
        <a href="https://dh.peakmzf.cn"><img alt="light year admin" src="/assets/images/logo.png" style="width:210px;height:60px"></a>
      </div>
      ...
      <footer class="col-sm-12 text-center text-white">
        <p class="m-b-0">Copyright © <?php echo date("Y")?> <a href="http://dh.peakmzf.cn">总裁导航系统</a>. All right reserved</p>
      </footer>
    </div>
  </div>
</div>
