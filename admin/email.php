    ...
    <div class="col-lg-12">
      <div class="card">
        <ul class="nav nav-tabs page-tabs">
          <li class="active"> <a class="active"href="#">邮箱配置</a> </li>
        </ul>
          ...
          <div class="tab-pane active">
            ...
            <form action="#!" id="config-edit" method="post" onsubmit="return false" class="edit-form">
              <div class="form-group">
                <label for="develop_mode">站点邮箱通知开关</label>
                <div class="controls-box">
                  <label class="lyear-radio radio-inline radio-primary">
                    <input type="radio" name="emailNotice" value="0" <?php echo $CONFIG['emailNotice'] == '0' ? 'checked' : ''; ?>><span>关闭</span>
                  </label>
                  <label class="lyear-radio radio-inline radio-primary">
                    <input type="radio" name="emailNotice" value="1" <?php echo $CONFIG['emailNotice'] == '1' ? 'checked' : ''; ?>><span>开启</span>
                  </label>
                </div>
              </div>

              <div class="form-group">
                <label for="web_site_title">SMTP服务器</label>
                <input class="form-control" type="text" value="<?php echo $CONFIG['smtpHost']; ?>" name="smtpHost"  placeholder="请输入SMTP服务器" >
              </div> 
  
               <div class="form-group">
                <label for="web_site_title">SMTP端口</label>
                <input class="form-control" type="text"  value="<?php echo $CONFIG['smtpPort']; ?>" name="smtpPort" placeholder="请输入SMTP端口" >
              </div> 

               <div class="form-group">
                <label for="web_site_title">SMTP邮箱</label>
                <input class="form-control" type="text"  value="<?php echo $CONFIG['smtpUsername']; ?>" name="smtpUsername" placeholder="请输入SMTP发信邮箱" >
              </div> 

               <div class="form-group">
                <label for="web_site_title">SMTP密码/授权码</label>
                <input class="form-control" type="text"  placeholder="请输入SMTP密码/授权码" value="<?php echo $CONFIG['smtpPassword']; ?>" name="smtpPassword" >
              </div> 

               <div class="form-group">
                <label for="web_site_title">收信邮箱</label>
                <input class="form-control" type="text"  value="<?php echo $CONFIG['smtpUsername']; ?>" name="email" id="email" placeholder="请输入收信邮箱" >
              </div> 
<blockquote class="layui-elem-quote-sf-info">
<?php
if ($conf['mail_name']) {
echo '<button type="button" class="layui-btn layui-btn-xs layui-btn-normal" id="mailtest">给 ';
echo $conf['mail_recv'] ? $conf['mail_recv'] : $conf['mail_name'];
echo ' 发一封测试邮件</button>';
}
?>
此功能为用户下单时给自己发邮件提醒。<br/>使用普通模式发信时，建议使用QQ邮箱，SMTP服务器smtp.qq.com，端口465，密码不是QQ密码也不是邮箱独立密码，是QQ邮箱设置界面生成的<a class="layui-btn layui-btn-xs layui-btn-warm" ew-href="http://service.mail.qq.com/cgi-bin/help?subtype=1&&no=1001256&&id=28"  target="_blank" rel="noreferrer">授权码</a>。为确保发信成功率，发信邮箱和收信邮箱最好同一个
</blockquote>              
              <div class="form-group">
