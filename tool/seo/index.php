    ...
    <div class="container">
        <div class="navbar-header">
            <h1 class="navbar-brand topbar-logo">
                <a title="<?php echo $config['page_title'];?>" href="/tool/t/seo"><?php echo $config['page_title'];?></a>
            </h1>
        </div>
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a href="https://dhceo.net" class="btn" target="_blank">
...
<footer class="container">
    Powered By <a href="<?php echo $config['footer_link'];?>" target="_blank"><?php echo $config['footer_link_text'];?></a> 版权所有
...
(function() {
  ...
  hm.src = "https://hm.baidu.com/hm.js?487415c6aa4c3622a6fa133266968470";
  var s = document.getElementsByTagName("script")[0]; 
  s.parentNode.insertBefore(hm, s);
})();
</script>
<span style="display:none"><script type="text/javascript" src="https://s9.cnzz.com/z_stat.php?id=1279310257&web_id=1279310257"></script></span>
