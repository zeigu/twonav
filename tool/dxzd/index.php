	...
	<body class="mdui-appbar-with-toolbar mdui-theme-accent-pink mdui-theme-primary-indigo"> 
		<header class="mdui-appbar mdui-appbar-fixed"> 
			<div class="mdui-color-theme mdui-toolbar"> 
				<span class="mdui-typo-title">短信炸弹</span> 
				<div class="mdui-toolbar-spacer"></div> 
				<a class="mdui-btn mdui-btn-icon" mdui-tooltip="{content: '更多工具'}" href="/tools.html"><i class="mdui-icon material-icons"></i></a>
				<a class="mdui-btn mdui-btn-icon" mdui-tooltip="{content: '总裁导航'}" href="http://dhceo.com"><i class="mdui-icon material-icons"></i></a>
			</div>
		</header>
