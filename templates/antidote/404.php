...
<html>
	...
	<body>
		<div class="container">
			<img src="<?php echo TEMPLATE_URL; ?>images/404.jpg" class="bg" />
			<div class="btn">
				<a href="/" class="goindex">回到首页</a>
				<a href="http://wpa.qq.com/msgrd?v=3&uin=3092059473&site=qq&menu=yes" target="_blank" class="lx">联系站长</a>
